...
namespace DeXign.Extension
{
    ...
    {
        public static IEnumerable<T> FindParents<T>(this Visual element, bool findAll = true) where T : Visual
        {
        ...
        public static IEnumerable<T> FindChildrens<T>(this Visual element, bool findAll = true) where T : Visual
        {
